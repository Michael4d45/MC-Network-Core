...
# SOF=15, TYPE=0, DST_WORLD_HI=0, DST_WORLD_LO=0, DST_PORT_HI=3, DST_PORT_LO=4, SRC_WORLD_HI=0, SRC_WORLD_LO=0, SRC_PORT_HI=1, SRC_PORT_LO=2, LEN_HI=0, LEN_LO=2, 10, 11, EOF=0
