 ...
 *
 * <p>
 * The CODE field is reserved for future application-layer use. In protocol v1,
 * CODE should be 0x0 for all standard IPv4 frames. Non-zero values (0x1–0xF)
 * may be used by future extensions to indicate priority, QoS flags, or other
 * transport metadata. Current implementation accepts but does not interpret
 * non-zero CODE values.
 *
 * <p>
 * IPv4 frames encapsulate Data (TYPE=0) or Data Control (TYPE=1) frames only.
 * All diagnostics, errors, and status reporting use Data Control frames,
...
public class IPv4Frame extends Frame {
    ...
    public static IPv4Frame from(int code, int[] args) {
        ...
        Frame encapsulatedFrame
            ...
            case 0 ->
                DataFrame.from(encapsulatedCode, encapsulatedArgs);
            case 1 ->
                new DataControlFrame(encapsulatedCode, encapsulatedArgs);
            case 3 ->
